...
public class CustomSortingAPI {
	...
	public void externalSortDirectory(String inputDirectory,
			String outputFile) {
		...
		try {
			...
			SortingUtility.mergeSortedFiles(tempSortedFlatFiles, new File(
					outputFile), (a, b) -> a.compareTo(b));
	...
	public  int minValInSortedRotatedList(
			List<Integer> sortedRotatedInputList) {
